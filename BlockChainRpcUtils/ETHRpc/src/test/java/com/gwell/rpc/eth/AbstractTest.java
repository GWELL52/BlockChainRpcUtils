...
public class AbstractTest {
    ...
    public ETHRpc etcRpc =
        ETHRpc.build("ip", 0, ChainIdLong.ETHEREUM_CLASSIC_TESTNET,
   Constant.DEFAULT_KEYSTORE_PATH);
    ...
    public EthAccount from = new EthAccount("privateKey");
    public EthAccount to = new EthAccount("privateKey");
